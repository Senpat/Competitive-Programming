      ...
      for(int q = 1; q <= t; q++){
         ...
         for(int k = n-2; k >= 0; k--){
            ...
            if(query == Integer.MIN_VALUE){
               ...
               updatemax(1,0,n,maxindexof[query],Integer.MIN_VALUE);
               updatemax(1,0,n,array[k],query);
               maxindexof[query] = array[k];
            }
         }
         ...
         for(int k = n-2; k >= 0; k--){
            ...
            if(query == Integer.MAX_VALUE){
               ...
               updatemin(1,0,n,minindexof[query],Integer.MAX_VALUE);
               updatemin(1,0,n,array[k],query);
               minindexof[query] = array[k];
            }
         }
