         ...
         */
         ...
         for(int k = 0; k < n; k++){
            ...
            if(minreq[k] == 0){
               ...
               if(reqs.get(minreq[k]-1).r >= reqs.get(minreq[k]).l){
                  //overlap case
                  pre = segtree.min(0,0,n-1,reqs.get(minreq[k]-1).l,reqs.get(minreq[k]).l-1);
               } else {
                  pre = segtree.min(0,0,n-1,reqs.get(minreq[k]-1).l,reqs.get(minreq[k]-1).r);
               }
