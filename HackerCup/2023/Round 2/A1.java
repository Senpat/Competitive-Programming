...
public class A1{
   ...
   public static void main(String[] args) throws IOException{
      BufferedReader f = new BufferedReader(new FileReader("a1_full_in.txt"));
      PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("a1_full_out.txt")));
      ...
      for(int q = 1; q <= t; q++){
         ...
         if(max >= 1){
            out.println("Case #" + q + ": YES");
         } else {
            out.println("Case #" + q + ": NO");
         }
      }
