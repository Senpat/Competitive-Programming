...
class rental2{
   ...
   public static void main(String[] args)throws IOException{
      ...
      for(int k = initial; k <= numcows; k++){
         ...
         max = Math.max(calculate(cow,stores,neigh,k),max);
   ...
   public static int calculate(PriorityQueue<Integer> cow, PriorityQueue<Store> stores, PriorityQueue<Integer> neigh, int i){
      int total = 0;
